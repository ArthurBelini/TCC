...
def odir_train_test_split(X: list, y: list, test_size : float = 0.20, data_path : Path = None, train_out_path : Path = None, test_out_path : Path = None):
    persons_eyes = {}
    X_train = []
    X_test = []
    y_train = []
...
if __name__ == '__main__':
    ...
    odir_train_test_split(X, y, data_path=data_path, train_out_path=train_out_path, test_out_path=test_out_path)
